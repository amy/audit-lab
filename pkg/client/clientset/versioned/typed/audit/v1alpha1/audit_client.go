...
// AuditV1alpha1Client is used to interact with features provided by the audit.aunem.io group.
...
func NewForConfig(c *rest.Config) (*AuditV1alpha1Client, error) {
	...
	return &AuditV1alpha1Client{client}, nil
}
