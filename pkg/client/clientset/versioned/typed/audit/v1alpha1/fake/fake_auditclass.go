...
var auditclassesKind = schema.GroupVersionKind{Group: "audit.aunem.io", Version: "v1alpha1", Kind: "AuditClass"}
...
func (c *FakeAuditClasses) Get(name string, options v1.GetOptions) (result *v1alpha1.AuditClass, err error) {
	...
	return obj.(*v1alpha1.AuditClass), err
}
...
func (c *FakeAuditClasses) List(opts v1.ListOptions) (result *v1alpha1.AuditClassList, err error) {
	...
	list := &v1alpha1.AuditClassList{ListMeta: obj.(*v1alpha1.AuditClassList).ListMeta}
	for _, item := range obj.(*v1alpha1.AuditClassList).Items {
